...
if __name__ == "__main__":
  ...
  parser.add_argument('--drop_prob_decoder', dest='drop_prob_decoder', type=float, default=0.0, help='what dropout to apply right before the decoder in an RNN/LSTM')
